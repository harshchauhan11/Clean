        ...
        <nav id="navbar-section" class="navbar navbar-default navbar-static-top navbar-sticky" role="navigation">
            <div class="container">
                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand wow fadeInDownBig" href="index.html"><img class="office-logo" src="../../cleaning project/clean_business/clean business/am logo/Capture2.PNG" alt="Office"></a>      
                </div>
                ...
                <div id="navbar-spy" class="collapse navbar-collapse navbar-responsive-collapse">
                    <ul class="nav navbar-nav pull-right">
                        ...
                        ?>
                        <li>
                            <a href="contact.html"><span>Apply as Worker</span></a>
                        </li>
                    </ul>         
                </div>
            </div>
                        ...
                        <div class="row services-row services-row-head services-row-1">
                            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                <div class="services-group wow animated fadeInLeft" data-wow-offset="40">
                                    <img src='<?php echo $row['path']; ?>' height='210' width='275'/>
                                    <h4 class="services-title"><?php echo $row['sname']; ?></h4>

                                    <p class="services-more"><a href="homerepair.html">Find Out More</a></p>
                                </div>
                            </div>
                            <?php
                        }
